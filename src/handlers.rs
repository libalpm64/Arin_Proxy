    ...
    if !request_allowed {
        match next_challenge_stage(clearance, current_stage) {
            ...
            Some(2) => {
                ...
                js_challenge.push_str("<!doctype html><html style=background:#121212><script type=module>import{run}from'https://cdn.jsdelivr.net/gh/libalpm64/Blake3-JS@ba52cf8d19e9855c860d34dfef22226f9c156067/arin-browser.js';run('");
